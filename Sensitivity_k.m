...
plot(k, Pi_S_NAA, 'k', 'MarkerSize', 5, 'LineWidth', 2); hold on;
plot(k, Pi_S_NWA, 'k-^', 'MarkerSize', 5, 'LineWidth', 2); hold on;
plot(k, Pi_P_NAA, 'b', 'MarkerSize', 5, 'LineWidth', 2.5); hold on;
plot(k, Pi_P_NWA, 'b--', 'MarkerSize', 5, 'LineWidth', 2.5); hold off;
...
xlabel('{\it{k}}');
ylabel('{\it{\Pi}}');
legend('\it{\Pi_S^{NA}}', '\it{\Pi_S^{NR}}', '\it{\Pi_P^{BA}}','\it{\Pi_P^{BR}}');
